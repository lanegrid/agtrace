...
pub fn present_watch_stream_update(
    ...
    let state_vm = WatchStreamStateViewModel {
        ...
        current_usage: crate::presentation::v2::view_models::ContextWindowUsageViewModel {
...
fn build_turns_from_session_v2(
    ...
    max_context: Option<u32>,
) -> Vec<crate::presentation::v2::view_models::TurnUsageViewModel> {
    use crate::presentation::v2::view_models::{StepItemViewModel, TurnUsageViewModel};
