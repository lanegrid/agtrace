...
use crate::presentation::v1::formatters::token::TokenUsageView;
...
impl SystemView for ConsoleTraceView {
    ...
    fn render_init_progress(&self, progress: &InitProgress) -> Result<()> {
        crate::presentation::v1::formatters::init::print_init_progress(progress);
        Ok(())
    }

    fn render_init_result(&self, result: &InitResult) -> Result<()> {
        crate::presentation::v1::formatters::init::print_init_result(result);
        Ok(())
    }
...
impl SessionView for ConsoleTraceView {
    ...
    fn render_pack_report(
        ...
        match template {
            ReportTemplate::Compact => crate::presentation::v1::views::pack::print_compact(digests),
            ReportTemplate::Diagnose => {
                crate::presentation::v1::views::pack::print_diagnose(digests)
            }
            ReportTemplate::Tools => crate::presentation::v1::views::pack::print_tools(digests),
        }
        Ok(())
    }
}
...
impl DiagnosticView for ConsoleTraceView {
    fn render_doctor_check(&self, result: &DoctorCheckResultViewModel) -> Result<()> {
        crate::presentation::v1::views::doctor::print_check_result_vm(result);
        Ok(())
    }
    ...
    fn render_diagnose_results(
        ...
        crate::presentation::v1::views::doctor::print_results(results, verbose);
        Ok(())
    }
...
impl WatchView for ConsoleTraceView {
    ...
    fn on_watch_initial_summary(&self, summary: &WatchSummary) -> Result<()> {
        ...
        if let Some(usage) = &summary.token_usage {
            if let Some(limit) = usage.limit {
                ...
                {
                    let bar = crate::presentation::v1::formatters::token::create_progress_bar(
    ...
    fn render_stream_update(
        ...
        _turns: Option<&[crate::presentation::v1::view_models::TurnUsageViewModel]>,
    ) -> Result<()> {
