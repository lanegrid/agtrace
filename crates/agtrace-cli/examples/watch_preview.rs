...
//!
//! ```sh
//! cargo run -p agtrace --example watch_preview            # replay events live
//! cargo run -p agtrace --example watch_preview -- --static # final state only
//! ```
//!
...
use agtrace::presentation::view_models::watch::UiState;
use agtrace::watch::{SharedWorkspace, WorkspaceSource, run};
