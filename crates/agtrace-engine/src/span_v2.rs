...
use crate::span::{Message, Span, TokenBundle, ToolAction};

/// Build spans from v2 events.
...
pub fn build_spans_v2(events: &[AgentEvent]) -> Vec<Span> {
...
mod tests {
    ...
    fn test_build_spans_v2_basic() {
        ...
        let spans = build_spans_v2(&events);
